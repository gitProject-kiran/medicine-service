...
module.exports = "<mat-toolbar color=\"primary\">\r\n    <span><i class=\"fa fa-renren\" aria-hidden=\"true\"></i></span>\r\n    <span class=\"example-fill-remaining-space\">POC Project</span>\r\n    <span>:</span>\r\n</mat-toolbar>\r\n\r\n<router-outlet></router-outlet>"
...
/* harmony import */ var _chart_dashboard_chart_dashboard_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chart-dashboard/chart-dashboard.component */ "./src/app/chart-dashboard/chart-dashboard.component.ts");
...
/* harmony import */ var src_app_angular_material_angular_material_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/angular-material/angular-material.module */ "./src/app/angular-material/angular-material.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _chart_dashboard_chart_dashboard_component__WEBPACK_IMPORTED_MODULE_7__["ChartDashboardComponent"],
            ...
            imports: [
                ...
                src_app_angular_material_angular_material_module__WEBPACK_IMPORTED_MODULE_9__["AngularMaterialModule"]
            ],
            providers: [],
...
/***/ "./src/app/chart-dashboard/chart-dashboard.component.css":
/*!***************************************************************!*\
  !*** ./src/app/chart-dashboard/chart-dashboard.component.css ***!
  \***************************************************************/
/*! no static exports found */
...
var ChartDashboardComponent = /** @class */ (function () {
    function ChartDashboardComponent(breakpointObserver) {
    ...
    ChartDashboardComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./chart-dashboard.component.css */ "./src/app/chart-dashboard/chart-dashboard.component.css")]
        }),
...
module.exports = "<mat-sidenav-container class=\"sidenav-container\">\n  <mat-sidenav #drawer class=\"sidenav\" fixedInViewport=\"true\" [attr.role]=\"(isHandset$ | async) ? 'dialog' : 'navigation'\"\n    [mode]=\"(isHandset$ | async) ? 'over' : 'side'\" [opened]=\"!(isHandset$ | async)\">\n    <mat-toolbar color=\"primary\">Agiliad</mat-toolbar>\n    <mat-nav-list>\n      <a mat-list-item [routerLink]=\"'/accounts'\"> Project Dashboard </a>\n      <a mat-list-item [routerLink]=\"'/create-account'\"> Project Configuration </a>\n      <a mat-list-item [routerLink]=\"'/contacts'\"> Webserver Configuration </a>\n      <a mat-list-item [routerLink]=\"'/create-contact'\">  Test Information </a>\n      <a mat-list-item [routerLink]=\"'/leads'\"> Manual Entry KPI </a>\n    </mat-nav-list>\n  </mat-sidenav>\n  <mat-sidenav-content>\n    <mat-toolbar color=\"primary\">\n      <button type=\"button\" aria-label=\"Toggle sidenav\" mat-icon-button (click)=\"drawer.toggle()\" *ngIf=\"isHandset$ | async\">\n        <mat-icon aria-label=\"Side nav toggle icon\">menu</mat-icon>\n      </button>\n      <span *ngIf=\"isHandset$ | async\">Agiliad</span>\n    </mat-toolbar>\n    <!-- Add Content Here -->\n\n    <app-chart-dashboard></app-chart-dashboard>\n  </mat-sidenav-content>\n</mat-sidenav-container>"
...
/***/ "./src/app/name/name-datasource.ts":
/*!*****************************************!*\
  !*** ./src/app/name/name-datasource.ts ***!
  \*****************************************/
/*! exports provided: NameDataSource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NameDataSource", function() { return NameDataSource; });
 ...
 */
var NameDataSource = /** @class */ (function (_super) {
    __extends(NameDataSource, _super);
    function NameDataSource(paginator, sort) {
     ...
     */
    NameDataSource.prototype.connect = function () {
        var _this = this;
     ...
     */
    NameDataSource.prototype.disconnect = function () { };
    /**
     * Paginate the data (client-side). If you're using server-side pagination,
     * this would be replaced by requesting the appropriate data from the server.
     */
    NameDataSource.prototype.getPagedData = function (data) {
     ...
     * this would be replaced by requesting the appropriate data from the server.
     */
    NameDataSource.prototype.getSortedData = function (data) {
        var _this = this;
...
/* harmony import */ var _name_datasource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./name-datasource */ "./src/app/name/name-datasource.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NameComponent = /** @class */ (function () {
    ...
    NameComponent.prototype.ngOnInit = function () {
        this.dataSource = new _name_datasource__WEBPACK_IMPORTED_MODULE_2__["NameDataSource"](this.paginator, this.sort);
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"]),
        __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatPaginator"])
    ], NameComponent.prototype, "paginator", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatSort"]),
        __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatSort"])
    ], NameComponent.prototype, "sort", void 0);
...
module.exports = __webpack_require__(/*! D:\angular\medicine-service\src\main.ts */"./src/main.ts");
